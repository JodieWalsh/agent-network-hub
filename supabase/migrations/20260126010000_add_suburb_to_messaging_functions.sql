-- =============================================
-- ADD SUBURB TO MESSAGING RPC FUNCTIONS
-- =============================================
-- Include home_base_address in conversation/participant data
-- so messaging UI can show suburb next to user names.
-- =============================================
...
-- Recreate get_user_conversations with suburb field
...
-- Recreate get_conversation_details with suburb field
