-- =============================================
-- FIX USER_TYPE ENUM CAST IN MESSAGING FUNCTIONS
-- =============================================
-- The profiles.user_type column is an enum type, not TEXT.
-- PostgreSQL requires explicit casting to match the declared
-- return type of TEXT in these functions.
-- =============================================

-- Fix get_user_conversations: cast user_type enum to TEXT
...
-- Fix get_conversation_details: cast user_type enum to TEXT
...
-- Fix get_conversation_participants: cast user_type enum to TEXT
